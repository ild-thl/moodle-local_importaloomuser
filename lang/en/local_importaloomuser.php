...
/**
 * Strings for component 'local_importaloomuser', language 'en', branch 'MOODLE_22_STABLE'
 *
 * @package    local
...
$string['aloomuser_profilfield_cron'] = 'aloom user profilfield syncronisation';
$string['aloomuser_cron'] = 'aloom user syncronisation';
...
$string['pluginname'] = 'aloom User upload';
...
$string['uploadusers'] = 'Upload aloom Users';
